      ...
      <div className='bg-slate-300 w-full h-screen'>
        <div className='w-[65%] mx-auto'>
            ...
            <div className='mt-5 w-full bg-white p-5'>
                ...
                <Link className='bg-sky-500 px-4 py-3 rounded-md text-xl font-mono font-bold text-white' href="https://connectifyglobal.azurewebsites.net/signupCounsel/signup_for_trainer">I am a trainer</Link>
