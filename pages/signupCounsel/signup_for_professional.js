...
const Signup_for_professional = () => {
    ...
    const onFormSubmit=(data)=>{
        ...
        fetch("https://connectifyindiasqldbserver.azurewebsites.net/simply-counsel/professional/",
        {
            method:'POST',
            body:formData
        }
...
export default Signup_for_professional