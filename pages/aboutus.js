    ...
    return (
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            ...
            <div className="lg:mt-14 sm:mt-10 mt-12">
                <Image className="lg:block hidden w-full" src="images\AINAW.png" width={1080} height={500}  alt="Group of people Chilling" />
                <img className="lg:hidden sm:block hidden w-full" src="images\Business Connect.png" alt="Group of people Chilling" />
                <img className="sm:hidden block w-full" src="images\Legal Aspire.png" alt="Group of people Chilling" />
            </div>
